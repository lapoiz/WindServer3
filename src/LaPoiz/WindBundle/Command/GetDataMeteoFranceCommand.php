...
class GetDataMeteoFranceCommand extends ContainerAwareCommand  {

 	protected function configure()
    {
        $this
            ->setName('lapoiz:getDataMeteoFrance')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
    	...
    	foreach ($dataWindPrevList as $dataWindPrev) {
            if ($dataWindPrev->getWebSite()->getNom() == WebsiteGetData::meteoFranceName) {
